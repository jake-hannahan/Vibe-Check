        ...
        <div className="relative group">
          <div className="z-10 p-8 bg-neutral-900 rounded-lg glow">
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                className="w-full text-white font-medium rounded-lg opacity-80 hover:opacity-100 text-sm px-5 py-2.5 text-center"
                style={{
            ...
            <div className="mt-8 text-center">
              ...
              >
                Don't have an account? Join the Vibes{" "}
                <span className="red-text">here.</span>
              </NavLink>
            </div>
          </div>
        </div>
