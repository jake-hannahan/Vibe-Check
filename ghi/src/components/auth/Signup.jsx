          ...
          <div className="z-10 p-8 bg-neutral-900 rounded-lg glow">
            <form className="space-y-6" onSubmit={handleSubmit}>
              <div className="text-center">
                <h5 className="text-2xl font-medium text-gray-300 dark:text-white">
                  Signup
                </h5>
              </div>
              {errorMessage && (
              ...
              <button
                type="submit"
                className="red-button w-full text-white opacity-80 hover:opacity-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center"
                style={{
