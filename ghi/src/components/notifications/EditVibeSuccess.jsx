...
import { setNotification } from "../../features/vibes/notificationSlice";

const EditVibeSuccess = (props) => {
	const dispatch = useDispatch();

	if (props.show.value === false) {
		return null;
	} else {
		return (
			<div
			...
			>
				<div className="text-md font-normal text-center">
					<p>
						You have <span style={{ color: "green" }}>successfully </span> edited a vibe! 🤙
					</p>
				</div>
				<button
					type="button"
