      ...
      <div className="container m-auto grid grid-cols-3 gap-1 w-screen h-screen font-raleway tracking-wider">
        ...
        <div className="p-8 col-span-3 bg-gray-400 bg-opacity-50 grid grid-cols-3 gap-1 w-100 drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)] rounded-md h-content">
          ...
          <div className="col-span-1 flex flex-col h-100">
            ...
            <h1 className="mt-8 text-center text-2xl text-white font-bold">
              🤙 You're Vibing With:
            </h1>
        ...
        <div className="col-span-3 flex justify-end items-end mt-1">
          <button className="text-white font-bold py-2 px-4 mb-8 rounded-full bg-gray-400 hover:bg-gray-700">
            <NavLink className="text-xl font-semibold text-white" to="../list">
              All the Vibes 🡆
            </NavLink>
          </button>
        </div>
