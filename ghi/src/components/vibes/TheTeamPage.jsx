...
function TheTeamPage() {
  const team = [
    ...
    },
    {
      ...
      description:
        "Knowledgeable Full-stack developer with expertise in backend technologies and a talent for creating efficient and effective code.",
    ...
    },
    {
      ...
      description:
        "Proficient Full-stack developer with expertise in both front-end technologies, and a dedication to creating user-friendly applications.",
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-4 xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 xs:grid-cols-1 text-white">
        {team.map((member) => (
          // Member Card
          <div
